/*--------------  reservationLast24Hs start ------------*/
if ($('#reservationLast24Hs').length) {
    var ctx = document.getElementById("reservationLast24Hs").getContext('2d');
            ...
            tooltips: {
               ...
               callbacks: {
                   label: function(tooltipItem, data) {
                                return 'R$ ' + convertDoubleToBR(tooltipItem.yLabel, 2, ',', '.')
                            },
                        },
            },
            animation: {
...
/*--------------  reservationLast24Hs End ------------*/

/*--------------  reservationLast7Days start ------------*/
if ($('#reservationLast7Days').length) {
    var ctx = document.getElementById("reservationLast7Days").getContext('2d');
    var chart = new Chart(ctx, {
        // The type of chart we want to create
        type: 'line',
        // The data for our dataset
        data: {
            labels: daysLast7Days,
            datasets: [{
                label: "Total em Vendas",
                backgroundColor: "rgba(117, 19, 246, 0.1)",
                borderColor: '#0b76b6',
...
/*--------------  reservationLast7Days End ------------*/

/*--------------  reservationLast30Days start ------------*/
if ($('#reservationLast30Days').length) {
    var ctx = document.getElementById("reservationLast30Days").getContext('2d');
    var chart = new Chart(ctx, {
        // The type of chart we want to create
        type: 'line',
        // The data for our dataset
    ...
    var myLineChart = new Chart(ctx, {
        ...
        options: {
            ...
            tooltips: {
               ...
               callbacks: {
                   label: function(tooltipItem, data) {
                                return 'R$' + convertDoubleToBR(tooltipItem.yLabel)
                            },
                        },
            },
            elements: {
