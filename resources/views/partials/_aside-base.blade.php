        ...
        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500" >
            <ul class="kt-menu__nav">
                <li class="kt-menu__item {{ in_array($current_page, ['events', 'edit-event']) ? 'kt-menu__item--active' : '' }}" aria-haspopup="true" >
                    <a href="{{ route('events') }}" class="kt-menu__link "><i class="kt-menu__link-icon flaticon2-calendar-6"></i><span class="kt-menu__link-text"><strong>Eventos</strong></span></a>
                </li>
                ...
                <li class="kt-menu__item {{ in_array($current_page, ['categories', 'add-category', 'edit-category', 'del-category']) ? 'kt-menu__item--active' : '' }} " aria-haspopup="true" >
                    <a href="{{ route('categories') }}" class="kt-menu__link "><i class="kt-menu__link-icon flaticon2-list-2"></i><span class="kt-menu__link-text"><strong>Categorias</strong></span></a>
                </li>
                ...
                <li class="kt-menu__item {{ in_array($current_page, ['users', 'register', 'user-permission', 'del-user', 'edit-user']) ? 'kt-menu__item--active' : '' }} " aria-haspopup="true" >
                    <a href="{{ route('users') }}" class="kt-menu__link "><i class="kt-menu__link-icon flaticon2-user-1"></i><span class="kt-menu__link-text"><strong>Usuários Sistema</strong></span></a>
                </li>
